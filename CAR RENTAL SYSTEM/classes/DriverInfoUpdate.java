...
public class DriverInfoUpdate {
    ...
    DriverInfoUpdate(String Name, String Experience,String VehicleType,String Rate,String Location,String Number) throws IOException{
           ...
           ResetExperience("data\\DriverInfo.txt", Name, Experience);
           ResetNumber("data\\DriverInfo.txt", Name, Number);
           ResetVehicleType("data\\DriverInfo.txt", Name, VehicleType);
           ResetRate("data\\DriverInfo.txt", Name, Rate);
           ResetLocation("data\\DriverInfo.txt", Name, Location);
